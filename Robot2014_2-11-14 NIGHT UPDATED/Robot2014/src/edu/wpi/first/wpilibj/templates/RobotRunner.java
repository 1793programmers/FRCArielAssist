...
public class RobotRunner extends IterativeRobot implements RobotComponent {
    ...
    private RobotComponent driveComp;
    private RobotComponent grabComp; 
    private RobotComponent launchComp;
    private RobotComponent liftComp;
    private RobotComponent cameraComp;
